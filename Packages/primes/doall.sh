...
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 21" "tests/21" 21
echo "Generating test #22"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 22" "tests/22" 22
echo "Generating test #23"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 23" "tests/23" 23
echo "Generating test #24"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 24" "tests/24" 24
echo "Generating test #25"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 25" "tests/25" 25
echo "Generating test #26"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 26" "tests/26" 26
echo "Generating test #27"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 27" "tests/27" 27
echo "Generating test #28"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 28" "tests/28" 28
echo "Generating test #29"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 29" "tests/29" 29
echo "Generating test #30"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 30" "tests/30" 30
echo "Generating test #31"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 31" "tests/31" 31
echo "Generating test #32"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 32" "tests/32" 32
echo "Generating test #33"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 33" "tests/33" 33
echo "Generating test #34"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 34" "tests/34" 34
echo "Generating test #35"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 35" "tests/35" 35
echo "Generating test #36"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 36" "tests/36" 36
echo "Generating test #37"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 37" "tests/37" 37
echo "Generating test #38"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 38" "tests/38" 38
echo "Generating test #39"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 39" "tests/39" 39
echo "Generating test #40"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 40" "tests/40" 40
echo "Generating test #41"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 41" "tests/41" 41
echo "Generating test #42"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 42" "tests/42" 42
echo "Generating test #43"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 43" "tests/43" 43
echo "Generating test #44"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 44" "tests/44" 44
echo "Generating test #45"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 45" "tests/45" 45
echo "Generating test #46"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 46" "tests/46" 46
echo "Generating test #47"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 47" "tests/47" 47
echo "Generating test #48"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 48" "tests/48" 48
echo "Generating test #49"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 49" "tests/49" 49
echo "Generating test #50"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 50" "tests/50" 50
echo "Generating test #51"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 51" "tests/51" 51
echo "Generating test #52"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 52" "tests/52" 52
echo "Generating test #53"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 53" "tests/53" 53
echo "Generating test #54"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 54" "tests/54" 54
echo "Generating test #55"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 55" "tests/55" 55
echo "Generating test #56"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 56" "tests/56" 56
echo "Generating test #57"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 57" "tests/57" 57
echo "Generating test #58"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 58" "tests/58" 58
echo "Generating test #59"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 59" "tests/59" 59
echo "Generating test #60"
scripts/gen-input-via-stdout.sh "wine files/Generator.exe 60" "tests/60" 60
echo ""
